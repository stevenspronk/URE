...
jQuery.sap.declare("URE.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("URE.Component", {
	metadata: {
		"name": "URE",
		...
		"config": {
			...
			serviceConfig: {
				...
				serviceUrl: "/destinations/McCoy_URE/"
			}
		},
		routing: {
	...
	init: function() {
		...
		var sRootPath = jQuery.sap.getModulePath("URE");
	...
	_initODataModel: function(sServiceUrl) {
		jQuery.sap.require("URE.util.messages");
		var oConfig = {
			metadataUrlParams: {},
			json: true,
		...
		oModel.attachRequestFailed(null, URE.util.messages.showErrorMessage);
