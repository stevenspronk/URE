...
onAfterRendering: function () {
		...
		loaded = true;	/* var dot = '<div style="text-align: left; width: 100%; height: 100%;  background-image: url(/IMG/dot.png); background-position: 50% 50%;  background-repeat: no-repeat;"></div>';   
...
bucketLive: function () {
	var router = sap.ui.core.UIComponent.getRouterFor(this);
		router.navTo("BucketLive", null, false);
	}
});