...
goToDetails: function () {
			...
			var start_date = new Date(oDetail.DateStart);
			...
			if (oDetail.Vomit === "X") {
				this.getView().byId("vomit").setSelected(true);
			}
			if (oDetail.Nausea === "X") {
				this.getView().byId("nausea").setSelected(true);
			}
			if (oDetail.Hypersensibility === "X") {
				this.getView().byId("hypersensibility").setSelected(true);
			}
