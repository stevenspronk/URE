jQuery.sap.declare("URE.util.messages");
 ...
 * @public
 */
URE.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = URE.util.messages._parseError(oParameter);
...
URE.util.messages.getErrorContent = function(oParameter) {
	return URE.util.messages._parseError(oParameter).sMessage;
};

URE.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
